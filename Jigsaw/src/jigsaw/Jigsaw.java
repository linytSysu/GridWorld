...
public class Jigsaw {
    ...
    public int weight1 = 3;
    public int weight2 = 7;
    public int weight3;
    ...
    public boolean BFSearch() throws IOException {
        ...
        isCompleted = false;
        Vector<JigsawNode> newfinds = new Vector<JigsawNode>();
        ...
        while (openList.size() > 0) {           
            ...
            pw.println("Searching.....Number of searched nodes:" + this.closeList.size() + 
                "   Current state:" + this.currentJNode.toString());
            System.out.println("Searching.....Number of searched nodes:" + this.closeList.size() + 
                "   Current state:" + this.currentJNode.toString());            

            newfinds = findFollowJNodes(currentJNode);
            for(JigsawNode jnode : newfinds) {
                openList.addElement(jnode);
            }
        }
